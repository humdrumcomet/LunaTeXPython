...
cd lua-5.3.6
patch -lup1 < ../../../patches/luaSOpatch.patch       # Patch the lua make files to build the shared
...
patch -lup1 < ../../patches/lunaticLocalLua.patch     # Patch the lunatic-python cmake files to
